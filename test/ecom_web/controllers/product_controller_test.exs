defmodule EcomWeb.ProductControllerTest do
  ...
  @create_attrs %{description: "some description", title: "some title", picture: "some picture", price: "120.5", views: 42}
  @update_attrs %{description: "some updated description", title: "some updated title", picture: "some updated picture", price: "456.7", views: 43}
  @invalid_attrs %{description: nil, title: nil, picture: nil, price: nil, views: nil}
