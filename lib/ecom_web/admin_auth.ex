defmodule EcomWeb.AdminAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_ecom_web_admin_remember_me"
  ...
  the current_admin:
      ...
      defmodule EcomWeb.PageLive do
        ...
        on_mount {EcomWeb.AdminAuth, :mount_current_admin}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{EcomWeb.AdminAuth, :ensure_authenticated}] do
